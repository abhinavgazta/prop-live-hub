...
export const mockReplaySessions: ReplaySession[] = [
  {
    id: "rep-1",
    title: "DLF The Camellias — Ultra Luxury 4BHK Tour",
    developer: "DLF Limited",
    locality: "Golf Course Road",
    position: [28.49, 77.085],
    airedAt: "2026-05-05T14:00:00Z",
    durationMin: 22,
    liveViewers: 4218,
    replayViews: 12_840,
    highlightCount: 6,
  ...
  {
    id: "rep-2",
    title: "M3M Golf Estate — Full Property Walkthrough",
    developer: "M3M India",
    locality: "Sector 65",
    position: [28.4646, 77.0266],
  ...
  {
    id: "rep-3",
    title: "Sobha City — Ready To Move Apartment Tour",
    developer: "Sobha Limited",
    locality: "Sector 108",
    position: [28.475, 77.04],
    airedAt: "2026-05-04T16:00:00Z",
    durationMin: 17,
    liveViewers: 2845,
    replayViews: 7_621,
    highlightCount: 5,
...
export const TYPE_COLORS: Record<SessionType, string> = {
  live: "#e11d48",
  upcoming: "#0ea5b7",
  replay: "#94a3b8", // Grey for completed/replay sessions
