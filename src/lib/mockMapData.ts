...
export const mockPOIs: PointOfInterest[] = [
  { id: "poi-1", name: "Cyber Hub", position: [28.4945, 77.0892], category: "Food", description: "Dining and entertainment hub" },
  { id: "poi-2", name: "Ambience Mall", position: [28.5042, 77.0988], category: "Shopping", description: "Major shopping mall" },
  { id: "poi-3", name: "HUDA City Centre Metro", position: [28.4595, 77.0724], category: "Transit", description: "Yellow Line interchange" },
  { id: "poi-4", name: "Leisure Valley Park", position: [28.4664, 77.0617], category: "Park", description: "Central green spine" },
  { id: "poi-5", name: "Medanta Hospital", position: [28.4395, 77.0414], category: "Healthcare", description: "Multi-specialty hospital" },
  { id: "poi-6", name: "GD Goenka School", position: [28.4202, 77.0431], category: "Education", description: "K-12 international school" },
];
